/*
  ...
  - Botón flotante abre/cierra un panel compacto.
  - Dos secciones plegables: "Cambiar colores light" y "Cambiar colores dark".
  - 1 input = 1 variable (usa tus variables existentes).
  - Persiste en localStorage y re-aplica al mutar el DOM (sin pisar cambios en vivo).
*/
(function(){
  ...
  const VAR_LABELS = {
    '--grad-stop1': 'Gradiente inicio',
    '--grad-stop2': 'Gradiente medio',
    '--grad-stop3': 'Gradiente final',
    '--light-uno-color': 'Color primario',
    '--light-dos-color': 'Color secundario',
    '--light-tres-color': 'Fondo suave',
    '--light-cuatro-color': 'Fondo transparente',
    '--light-cinco-color': 'Texto destacado',
    '--light-seis-color': 'Texto oscuro',
    '--dark-uno-color': 'Dark primario',
    '--dark-dos-color': 'Dark secundario',
    '--dark-tres-color': 'Dark fondo',
    '--dark-cuatro-color': 'Dark fondo transparente',
    '--dark-cinco-color': 'Dark acento',
  };

  // === Variables existentes en tu :root ===
  const VARS_LIGHT = [
    '--grad-stop1',
    '--grad-stop2',
    '--grad-stop3',
  ...
  // === UI ===
  const CSS = `
    .ft-btn { position: fixed; right: 14px; bottom: 14px; z-index: 9999;
      padding: 8px 10px; border-radius: 10px; border: 1px solid #00000033;
      background: #1f1f1f; color: #fff; cursor: pointer; font: 600 13px system-ui;
      box-shadow: 0 6px 24px rgba(0,0,0,.35); }
    .ft-panel { position: fixed; right: 14px; bottom: 56px; z-index: 9999;
