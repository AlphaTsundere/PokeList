...
(function(){
  ...
  // === UI ===
  const CSS = `
    .btn-colorp { position: fixed; left: 14px; bottom: 14px; z-index: 9999;
      padding: 8px 10px; border-radius: 10px; border: 1px solid #00000033; color: #fff; cursor: pointer; font: 600 13px system-ui;
      box-shadow: 0 6px 24px rgba(0,0,0,.35); }
    .ft-panel { position: fixed; left: 14px; bottom: 56px; z-index: 9999;
      width: 320px; max-height: 65vh; overflow:auto; padding: 10px; color: #eee; border: 1px solid #00000044;
...
(function () {
  ...
  function mount(){
    ...
    let btn = document.querySelector('.btn-colorp');
    if (!btn){
      btn = document.createElement('button');
      btn.className = 'btn-colorp';
