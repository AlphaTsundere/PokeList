...
(function(){
  ...
  // === UI ===
  const CSS = `
    .ftn-btnth { position: fixed; left: 14px; bottom: 14px; z-index: 9999;
...
(function () {
    ...
    panel.innerHTML = `
      <div class="ft-head">
        ...
        <div class="ft-actions">
          <button class="ftn-btnth-small js-export" title="Exportar colores"><i class="fa-solid fa-download"></i></button>
          <button class="ftn-btnth-small js-import" title="Importar colores"><i class="fa-solid fa-upload"></i></button>
  ...
  function mount(){
    ...
    let btn = document.querySelector('.ftn-btnth');
    if (!btn){
      btn = document.createElement('button');
      btn.className = 'ftn-btnth';
